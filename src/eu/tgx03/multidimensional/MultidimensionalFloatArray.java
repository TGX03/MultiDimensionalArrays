...
public class MultidimensionalFloatArray extends AbstractMultidimensionalArray implements Cloneable {
	 ...
	 */
	public MultidimensionalFloatArray(int @NotNull ... dimensions) {
	 ...
	 */
	private MultidimensionalFloatArray(int @NotNull [] dimensions, float @NotNull [] values) {
	 ...
	 */
	@Contract(pure = true)
	public float get(int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	 ...
	 * @throws ArrayIndexOutOfBoundsException Means that at one stage the index was higher than the actual dimension of the array.
	 */
	public void set(float value, int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	...
	public boolean equals(@Nullable Object o) {
		if (o instanceof MultidimensionalFloatArray m)
			return Arrays.equals(this.dimensions, m.dimensions) && Arrays.equals(this.values, m.values);
		else return false;
	}

	@Override
	public MultidimensionalFloatArray clone() {
		return new MultidimensionalFloatArray(this.dimensions, Arrays.copyOf(this.values, this.values.length));
	}
}
