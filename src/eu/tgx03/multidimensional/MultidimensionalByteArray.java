...
public class MultidimensionalByteArray extends AbstractMultidimensionalArray implements Cloneable {
	 ...
	 */
	public MultidimensionalByteArray(int @NotNull ... dimensions) {
		super(true, dimensions);
		int dimension = 1;
		for (int value : dimensions) {
			dimension = dimension * value;
		}
		this.values = new byte[dimension];
	}
	 ...
	 */
	private MultidimensionalByteArray(int @NotNull [] dimensions, byte @NotNull [] values) {
	 ...
	 */
	@Contract(pure = true)
	public byte get(int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	 ...
	 * @throws ArrayIndexOutOfBoundsException Means that at one stage the index was higher than the actual dimension of the array.
	 */
	public void set(byte value, int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	...
	public boolean equals(@Nullable Object o) {
		if (o instanceof MultidimensionalByteArray m)
			return Arrays.equals(this.dimensions, m.dimensions) && Arrays.equals(this.values, m.values);
		else return false;
	}

	@Override
	public MultidimensionalByteArray clone() {
		return new MultidimensionalByteArray(this.dimensions, Arrays.copyOf(this.values, this.values.length));
	}
}
