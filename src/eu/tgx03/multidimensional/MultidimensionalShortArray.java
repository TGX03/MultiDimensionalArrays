...
public class MultidimensionalShortArray extends AbstractMultidimensionalArray implements Cloneable {
	 ...
	 */
	public MultidimensionalShortArray(int @NotNull ... dimensions) {
		super(true, dimensions);
		int dimension = 1;
		for (int value : dimensions) {
			dimension = dimension * value;
		}
		this.values = new short[dimension];
	}
	 ...
	 */
	private MultidimensionalShortArray(int @NotNull [] dimensions, short @NotNull [] values) {
	 ...
	 */
	@Contract(pure = true)
	public short get(int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	 ...
	 * @throws ArrayIndexOutOfBoundsException Means that at one stage the index was higher than the actual dimension of the array.
	 */
	public void set(short value, int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	...
	public boolean equals(@Nullable Object o) {
		if (o instanceof MultidimensionalShortArray m)
			return Arrays.equals(this.dimensions, m.dimensions) && Arrays.equals(this.values, m.values);
		else return false;
	}

	@Override
	public MultidimensionalShortArray clone() {
		return new MultidimensionalShortArray(this.dimensions, Arrays.copyOf(this.values, this.values.length));
	}
}
