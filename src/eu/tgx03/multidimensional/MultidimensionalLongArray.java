...
public class MultidimensionalLongArray extends AbstractMultidimensionalArray implements Cloneable {
	 ...
	 */
	public MultidimensionalLongArray(int @NotNull ... dimensions) {
		super(true, dimensions);
		int dimension = 1;
		for (int value : dimensions) {
			dimension = dimension * value;
		}
		this.values = new long[dimension];
	}
	 ...
	 */
	private MultidimensionalLongArray(int @NotNull [] dimensions, long @NotNull [] values) {
	 ...
	 */
	@Contract(pure = true)
	public long get(int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	 ...
	 * @throws ArrayIndexOutOfBoundsException Means that at one stage the index was higher than the actual dimension of the array.
	 */
	public void set(long value, int @NotNull ... coordinates) throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
	...
	@Override
	public MultidimensionalLongArray clone() {
		return new MultidimensionalLongArray(this.dimensions, Arrays.copyOf(this.values, this.values.length));
	}
}
